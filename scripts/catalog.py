...
STATES = [
    ...
    dict(clip='04_BuocDi_CoBan',     order=5,  icon='🏃',   accent='#a3a3a3',
         label='Đi Cơ Bản',          desc='Bước đi cơ bản', beat_sync=True),
    dict(clip='05_BuocDi_TuNhien',   order=6,  icon='🚶',   accent='#4ade80',
         label='Đi Tự Nhiên',        desc='Bước đi dồn trọng tâm chân trụ', beat_sync=True),
    ...
    dict(clip='15_BuocDi_Mocap',     order=15, icon='🎯', accent='#22d3ee',
         label='Đi (Mocap)',         desc='Bước đi retarget từ mocap thật', beat_sync=True),
    dict(clip='16_VayTay_Mocap',     order=16, icon='🙋', accent='#34d399',
         label='Vẫy Tay (Mocap)',    desc='Vẫy tay chào, retarget từ mocap', beat_sync=True),
    dict(clip='17_NhayMua_Mocap',    order=17, icon='💃', accent='#fb923c',
         label='Vũ Đạo (Mocap)',     desc='Một đoạn vũ đạo retarget từ mocap', beat_sync=True, dance=True),
    ...
    dict(clip='19_NhayMuaDai_Mocap', order=19, icon='🕺', accent='#f43f5e',
         label='Vũ Đạo Dài (Mocap)', desc='Vũ đạo dài, cắt theo chu kỳ chuyển động', beat_sync=True, dance=True),
]
