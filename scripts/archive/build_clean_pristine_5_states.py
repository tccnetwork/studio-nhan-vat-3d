...
def build_pristine_5_states():
    print(">>> 1. Loading Base Character...")
    clean_scene()
    ...
    # Identify Xbot walk action and delete all other 50+ actions in bpy.data.actions
    xbot_walk_act = [a for a in bpy.data.actions if a.name == 'walk'][0]
    for a in list(bpy.data.actions):
        if a != xbot_walk_act:
            bpy.data.actions.remove(a)

    print(">>> Purged all old duplicate actions! Remaining in memory:", [a.name for a in bpy.data.actions])
    ...
    source_arm.animation_data.action = xbot_walk_act
    ...
    # =========================================================================
    print(">>> 5. Creating 05_BuocDi_TuNhien from Three.js Official Mixamo Walk...")
    ...
    # Remove Xbot source object and source actions
    bpy.data.actions.remove(xbot_walk_act)
    ...
    # Push all 5 pristine actions to NLA Tracks
    ...
    print(">>> PRISTINE 5 STATES EXPORTED!")

if __name__ == '__main__':
    build_pristine_5_states()
