...
def merge_vertex_groups(mesh_obj, source_group_name, target_group_name):
    """Merges vertex weights from source_group to target_group on mesh_obj."""
...
def fix_and_bind_model_B_clothing():
    print(">>> 1. Importing Model B to perfectly bind Shirt & Shorts to Armature...")
    clean_scene()
    ...
    # 1. BIND CLOTHING VERTEX GROUPS DIRECTLY TO HUMANOID BONES
    body_obj = None
    ...
    if body_obj:
        ...
        # Shirt Left Sleeve: Merge secondary sleeve weights into J_Bip_L_UpperArm
        ...
        # Shirt Right Sleeve: Merge secondary sleeve weights into J_Bip_R_UpperArm
        ...
        # Shorts Left Leg: Merge secondary leg weights into J_Bip_L_UpperLeg
        ...
        # Shorts Right Leg: Merge secondary leg weights into J_Bip_R_UpperLeg
        ...
        print("Vertex weights successfully bound to main bones!")

    # 2. KEYFRAME ALL BONES (MAIN + SECONDARY) IN ANIMATION ACTION
    armature = [o for o in bpy.data.objects if o.type == 'ARMATURE'][0]
    bpy.context.view_layer.objects.active = armature
    armature.animation_data_create()
    
    action = bpy.data.actions.new(name="01_Idol_FullBody_Singing_Dance")
    ...
    for frame in range(1, 241):
        ...
        # LEGS & SHORTS (GẬP ĐẦU GỐI & QUẦN CHUYỂN ĐỘNG THEO CHÂN)
        ...
        if l_up and l_low:
            ...
            # Secondary shorts bones follow left leg
        ...
        if r_up and r_low:
            ...
            # Secondary shorts bones follow right leg
        ...
        # ARMS, FOREARMS & SHIRT SLEEVES (ÁO CỬ ĐỘNG 100% THEO CÁNH TAY)
        ...
        if r_arm and r_fore:
            ...
            # Right Shirt Sleeve bones follow upper arm
        ...
        # Left Arm (Expressive Idol Gestures)
        ...
        if l_arm and l_fore:
            ...
            # Left Shirt Sleeve bones follow upper arm
        ...
        for pb in armature.pose.bones:
            if 'Hair' in pb.name:
                ...
                pb.rotation_quaternion = mathutils.Euler((-math.sin(beat_t) * 0.10, 0.0, -math.sin(beat_t * 0.5) * 0.12), 'XYZ').to_quaternion()
    ...
    print(">>> Model B Clothing Skinning & Full Articulation Exported Successfully!")

if __name__ == '__main__':
    fix_and_bind_model_B_clothing()
    print("=== MODEL B CLOTHING BINDING COMPLETE ===")
